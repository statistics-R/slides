...
#Instalación de R (Windows)
.small[Seleccionamos la ruta de instalación, lugar donde se localizará el software, con todos los archivos necesarios para su funcionamiento, como los paquetes. Lo recomendado es dejar la ruta predeterminada]
.center[
![](img/r-windows4.png)
]
---
...
#Instalación de R (Windows)
.tiny[Al preguntar sobre la carpeta del menú de inicio, dejar la configuración predeterminada y seleccionar Siguiente. También, si lo desean, pueden optar por no crear una carpeta en el menú Inicio, marcando la casilla correspondiente. Según se desee, marcar o desmarcar las casillas de creación de accesos directos. Marcar las casillas de registro de entradas: Guarde el número de versión en el registro, y Asociar archivos .RData con R. Luego, finalizar la instalación.] .center.middle[
![](img/r-windows7.png)
]
...
.box-inv-1.medium[En este caso, el proceso de instalación es el mismo. Tal como cuando se instala cualquier otra aplicación en macOS, hay que ejecutar el archivo descargado, luego arrastrar el ícono a la carpeta de aplicaciones y, por último, seguir los pasos de instalación anteriormente señalados.]
---
class: title title-2 top-logo  
...
#Instalación de RStudio 
- .small[Luego, en la sección All Installers, descargar la versión de RStudio correspondiente a nuestro sistema operativo.] <br>
- .small[Posteriormente, proseguir con la instalación, siguiendo los mismos pasos que con R:]<br>
- .small[Ejecutar el archivo.]<br>
- .small[Definir el destino de instalación (se recomienda mantener la ruta predeterminada)]<br>
- .small[Seleccionar la Carpeta del Menú de Inicio donde se desea crear accesos directos, o clickear la casilla correspondiente en caso de no querer crear accesos directos.]<br>
- .small[Finalizar el proceso de instalación.]
---
class: title title-2 top-logo  
